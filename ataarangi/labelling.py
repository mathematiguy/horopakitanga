...
def confirm_description(description):
    ...
    confirm = input(
        f"Confirm description '{description}' (hit enter to confirm or type to edit): "
    )
    if confirm == "":  # If user hits enter, confirm the description
        ...
        return confirm_description(
            input("Please enter a new description: ")
        )  # Recursive call for new description
    ...
    while budget < 8.0:
        for _ in range(num_states):
            ...
            if all_selected:
                ...
                description = input(
                    "Please enter your description for the world state: "
                )
